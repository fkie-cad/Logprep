...
class Registry:
    ...
    _non_ng_mapping: ComponentTypeMap = {
        ...
        "field_name_replacer": "logprep.processor.field_name_replacer.processor.FieldNameReplacer",
    ...
    _ng_mapping: ComponentTypeMap = {
        ...
        "field_name_replacer": "logprep.ng.processor.field_name_replacer.processor.FieldNameReplacer",
