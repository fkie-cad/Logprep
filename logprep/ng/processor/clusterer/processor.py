...
class Clusterer(FieldManager):
    ...
    def __init__(self, name: str, configuration: "Clusterer.Config"):
    ...
    def _apply_rules(self, event: dict, rule: ClustererRule) -> None:
    ...
    def _get_text_to_cluster(self, rule: ClustererRule, event: dict) -> Tuple[str | None, str | None]:
        sig_text = None
