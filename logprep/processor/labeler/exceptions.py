...
class RuleDoesNotConformToLabelingSchemaError(LabelerConfigurationError):
    ...
    def __init__(self, name: str, path: str):
        super().__init__(name, f'Invalid rule file "{path}": Does not conform to labeling schema.')
...
class RulesDefinitionMissingError(InvalidLabelerFactoryConfigurationError):
    ...
    def __init__(self):
        super().__init__(
            "The labeler configuration must contain at least one path to a rules " "directory."
        )
