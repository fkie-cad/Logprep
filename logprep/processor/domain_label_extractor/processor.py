...
from logprep.abc.processor import list_of_files_validator
...
class DomainLabelExtractor(Processor):
    ...
    class Config(Processor.Config):
        ...
        to :code:`tags`."""
        tld_lists: list = field(
            default=None, validator=[list_of_files_validator], metadata={"file_extension": ".dat"}
        )
