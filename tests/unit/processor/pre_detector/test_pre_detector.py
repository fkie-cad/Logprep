...
class TestPreDetector:
    ...
    def test_perform_successful_pre_detection_with_pre_detector_complex_rule_suceeds_msg_t1(
        self, pre_detector
    ):
        assert pre_detector.ps.processed_count == 0
    ...
    def test_perform_successful_pre_detection_with_pre_detector_complex_rule_succeeds_msg_t2(
        self, pre_detector
    ):
        assert pre_detector.ps.processed_count == 0
