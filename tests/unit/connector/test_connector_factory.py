...
from logprep.connector.connector_factory import (InvalidConfigurationError, ConnectorFactory,
...
class TestConnectorFactory:
    ...
    def test_fails_to_create_a_connector_when_type_is_unknown(self):
        for unknown_type in ['test', 'unknown', 'this is not a known type']:
            with raises(UnknownConnectorTypeError, match='Unknown connector type: "%s"' % unknown_type):
