...
class TestConfluentKafkaInput(BaseInputTestCase, CommonConfluentKafkaTestCase):
    ...
    def test_metrics_expose_returns_data(self):
        ...
        expected = {
            ...
            f"logprep_connector_librdkafka_ts;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 5016483227792,
            f"logprep_connector_librdkafka_time;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 1527060869,
            f"logprep_connector_librdkafka_replyq;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 0,
            f"logprep_connector_librdkafka_msg_cnt;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 22710,
            f"logprep_connector_librdkafka_msg_size;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 704010,
            f"logprep_connector_librdkafka_msg_max;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 500000,
            f"logprep_connector_librdkafka_msg_size_max;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 1073741824,
            f"logprep_connector_librdkafka_simple_cnt;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 0,
            f"logprep_connector_librdkafka_metadata_cache_cnt;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 1,
            f"logprep_connector_librdkafka_tx;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 631,
            f"logprep_connector_librdkafka_tx_bytes;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 168584479,
            f"logprep_connector_librdkafka_rx;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 631,
            f"logprep_connector_librdkafka_rx_bytes;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 31084,
            f"logprep_connector_librdkafka_txmsgs;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 4300753,
            f"logprep_connector_librdkafka_txmsg_bytes;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 133323343,
            f"logprep_connector_librdkafka_rxmsgs;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 0,
            f"logprep_connector_librdkafka_rxmsg_bytes;direction:input,name:Test Instance Name,type:confluentkafka_input,client_id:{client_id},group_id:testgroup": 0,
