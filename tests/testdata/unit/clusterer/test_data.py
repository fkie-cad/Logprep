...
class DatasetSignatureProcessing:
    ...
    test_record_1.sig_list = [
        '<+>sendmail</+>', '<+>to</+>', '<+>ctladdr</+>', '<+>delay</+>', '<+>xdelay</+>',
        '<+>mailer</+>', '<+>pri</+>', '<+>dsn</+>', '<+>stat</+>', '<+>did</+>', '<+>not</+>',
        '<+>issue</+>', '<+>during</+>', '<+>xinetd</+>', '<+>Version</+>', '<+>Daemon</+>',
        '<+>already</+>', '<+>DHCPREQUEST</+>', '<+>of</+>', '<+>on</+>', '<+>to</+>',
        '<+>port</+>', '<+>Failed</+>', '<+>password</+>', '<+>for</+>', '<+>root</+>',
        '<+>from</+>', '<+>port</+>', '<+>authentication</+>', '<+>logname</+>', '<+>uid</+>',
        '<+>euid</+>', '<+>tty</+>', '<+>ruser</+>', '<+>rhost</+>', '<+>user</+>', '<+>to</+>',
        '<+>ctladdr</+>', '<+>delay</+>', '<+>xdelay</+>', '<+>mailer</+>', '<+>pri</+>',
        '<+>dsn</+>', '<+>Potential</+>', '<+>Corporate</+>', '<+>Privacy</+>', '<+>Closed</+>',
        '<+>dest</+>', '<+>port</+>', '<+>used</+>', '<+>local</+>', '<+>dest</+>', '<+>syn</+>',
        '<+>IN</+>', '<+>PHYSIN</+>', '<+>OUT</+>', '<+>PHYSOUT</+>', '<+>SRC</+>', '<+>DST</+>',
        '<+>LEN</+>', '<+>TOS</+>', '<+>PREC</+>', '<+>TTL</+>', '<+>ID</+>', '<+>PROTO</+>',
        '<+>SPT</+>', '<+>DPT</+>', '<+>LEN</+>'
    ]
    ...
    test_record_1.sig_token_pos_list = [
        [1, 16], [31, 40], [42, 56], [65, 77], [79, 92], [94, 107], [109, 119], [121, 131],
        [133, 144], [146, 156], [157, 167], [168, 180], [201, 214], [216, 229], [230, 244],
        [273, 286], [287, 301], [311, 329], [330, 339], [354, 363], [369, 378], [391, 402],
        [412, 425], [426, 441], [442, 452], [453, 464], [465, 476], [493, 504], [517, 538],
        [548, 562], [564, 574], [576, 587], [589, 599], [601, 613], [615, 627], [630, 641],
        [643, 652], [654, 668], [677, 689], [691, 704], [706, 719], [721, 731], [733, 743],
        [762, 778], [779, 795], [796, 810], [882, 895], [896, 907], [908, 919], [920, 931],
        [933, 945], [946, 957], [959, 969], [1024, 1033], [1035, 1048], [1050, 1060],
        [1062, 1076], [1078, 1088], [1090, 1100], [1102, 1112], [1114, 1124], [1126, 1137],
        [1139, 1149], [1151, 1160], [1162, 1174], [1176, 1186], [1188, 1198], [1200, 1210]
    ]
...
class DatasetTestSignaturePhase(SimpleNamespace):
    ...
    kernel_log_1.sig_list = [
        '<+>kernel</+>', '<+>INBOUND</+>', '<+>UDP</+>', '<+>IN</+>', '<+>PHYSIN</+>',
        '<+>OUT</+>', '<+>PHYSOUT</+>', '<+>SRC</+>', '<+>DST</+>', '<+>LEN</+>', '<+>TOS</+>',
        '<+>PREC</+>', '<+>TTL</+>', '<+>ID</+>', '<+>PROTO</+>', '<+>SPT</+>', '<+>DPT</+>',
        '<+>LEN</+>'
    ]
    ...
    log_record_list = (kernel_log_1, kernel_log_2, sendmail_log_1,
                       sendmail_log_2, sshd_log_1, sshd_log_2)
    log_records = collections.OrderedDict()

    for log_record in log_record_list:
        log_records[log_record.number] = LogRecord(raw_text=log_record.raw_text,
                                                   number=log_record.number)
...
class LogSaltModeTestComposition(SimpleNamespace):
    rules = [SignatureRulesTest.rule_1, SignatureRulesTest.rule_2, SignatureRulesTest.rule_3,
